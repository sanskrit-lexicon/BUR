...
CODE = os.environ.get("DICT", "bur")
LANGS = {
  "fr": (".md", f"{CODE}pref_all.fr.md", "Front matter — French (source)", "Page", "Source (scan)"),
  "en": (".en.md", f"{CODE}pref_all.en.md", "Front matter — English", "Page", "Source (scan)"),
...
for lang,(suf,outname,title,pw,srcw) in LANGS.items():
    ...
    print("wrote", outname, "pages", len(body))
