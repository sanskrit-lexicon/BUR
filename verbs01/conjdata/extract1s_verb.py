...
"""extract1s_verb.py
 ...
 This specifically for normroot-conj-spcl.txt
"""
...
def correction(k1,form):
 if form in correction_dict:
  t = correction_dict[form]
  newform,newverb = t.split(',')
  if k1 == newverb:
   return newform
